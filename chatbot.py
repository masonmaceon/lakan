...
class CampusChatbot:
    ...
    def generate_building_mappings(self):
        ...
        manual_aliases = {
            ...
            'bahay pagasa': 'bahay_pagasa_dasmariñas',
            'bahay pag-asa': 'bahay_pagasa_dasmariñas',
            'high school': 'high_school_complex',
            'high school complex': 'high_school_complex',
            'hotel rafael': 'hotel_rafael',
            'rafael': 'hotel_rafael',
            'residencia': 'Residencia',
            'residencia de san miguel': 'Residencia',
            'ladies dorm': 'Ladies Dorm',
            'ladies dormitory': 'Ladies Dorm',
            'mens dorm': 'Mens Dorm',
            'mens dormitory': 'Mens Dorm',
            "men's dorm": 'Mens Dorm',
            "women's dorm": 'Ladies Dorm',
            'museo': 'Museo',
            'museo de la salle': 'Museo',
            'museum': 'Museo',
            'library': 'Library',
            'rizal library': 'Library',
            'fdh': 'FDH',
            'fe del mundo': 'FDH',
            'vbh': 'VBH',
            'gmh': 'GMH',
